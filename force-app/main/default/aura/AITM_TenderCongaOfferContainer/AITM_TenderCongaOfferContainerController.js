({
    ...
    onFilterCustomerChange : function(component, event, helper) {
        helper.onFilterCustomerChange(component, event);
    },
    ...
    generate : function(component, event, helper) {
        ...
        if(isOldTender || (!checkValue)){
            ...
            helper.generateCongaOfferWithRefresh(component, event, helper);
        }*/
    },
    ...
    showTaxesCheckBox : function(component, event, helper) {
        component.set("v.offerSelection", event.getSource().get("v.value"));
