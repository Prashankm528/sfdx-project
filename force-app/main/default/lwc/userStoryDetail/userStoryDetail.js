...
import releatedFiles from '@salesforce/apex/UserStoryClass.releatedFiles';
import saveFile from '@salesforce/apex/UserStoryClass.saveFile';
import {ShowToastEvent} from 'lightning/platformShowToastEvent';
const columns = [
    {label: 'Title', fieldName: 'Title'}
];
export default class UserStoryDetail extends LightningElement {
    @api recordId;
